...
<div class="max-w-4xl mx-auto">
    <div class="mb-6 flex justify-between items-center">
        ...
        <button onclick="exportToHTML()" class="bg-gray-900 hover:bg-gray-800 text-white text-sm font-medium px-4 py-2 rounded-lg transition flex items-center gap-2">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
